...
ip_cluster_path <- "Class_Consensus_Clustering_K_2.csv" #in kmeans_reduced_mrna_mirna_meth working directory 
ip_cluster_path 
...
png_op_os_path <- "OverallSurvival.png"
png(png_op_os_path)
